...
-   build: add .npmignore to remove unneeded files from npm package ([`91513f1`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/91513f1))
-   build: add .gitattributes to force LF (instead of possible CRLF on Windows) ([`d4e8607`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/d4e8607))
-   docs(android): mention 2 lines content limit ([#125](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/issues/125)) ([`292e13a`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/292e13a))
-   ci(travis): Update Travis CI configuration for new paramedic ([#127](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/issues/127)) ([`f6e4165`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/f6e4165))
-   refactor(android): Cleanup Dialog plugin code ([#123](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/issues/123)) ([`419a838`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/419a838))
-   chore(github) Add or update GitHub pull request and issue template ([`d5f09ce`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/d5f09ce))
-   refactor: Cleanup: remove trailing whitespace ([#120](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/issues/120)) ([`ed0e465`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/ed0e465))
-   docs: remove JIRA link ([`0057715`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/0057715))
-   docs: Remove docs translations ([#107](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/issues/107)) ([`b87526e`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/b87526e))
-   ci(travis): also accept terms for android sdk `android-27` ([#102](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/issues/102)) ([`6d88a8c`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/6d88a8c), [`2bc54cf`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/2bc54cf))
-   ci(travis): CB-13756: Add build-tools-26.0.2 to travis ([`ef89d9f`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/ef89d9f))
-   chore(release): Fix release notes ([#101](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/issues/101)) ([`c24c733`](https://github.com/cjmartin6162/cordova-plugin-alpha-dialogs-file-xhr.git/commit/c24c733))
